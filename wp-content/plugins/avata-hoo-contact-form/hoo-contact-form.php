...
/*
	...
	Description: HooThemes Contact Form.
	Author: HooThemes
	Author URI: https://www.hoothemes.com/
	Version: 1.0.0
...
if(!class_exists('hooContactform')){
	...
	class hooContactform{
		...
		function frontend_scripts() {
			...
			$labels['captcha_error'] = __('Captcha Error.', 'hoo-contact-form');
...
<form id="hoo-contactForm" class="form-horizontal" method="post" action="#">
    ...
    if($display_labels == '1' )
	  $form .= '<div class="form-group form-horizontal">
